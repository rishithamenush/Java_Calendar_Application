...
public class ScriptParser implements ScriptParserConstants {
  ...
  final public void Event() throws ParseException {Token date, time, duration, title;
    jj_consume_token(EVENT);
    date = jj_consume_token(DATE);
    time = jj_consume_token(TIME);
    duration = jj_consume_token(INTEGER);
...
System.out.println("Parsed Event: Date=" + date.image + " Time=" + time.image + " Duration=" + duration.image + " Title=" + title.image);
  ...
  final public void Plugin() throws ParseException {Token pluginId, key1, key2;
    jj_consume_token(PLUGIN);
    pluginId = jj_consume_token(STRING);
    key1 = jj_consume_token(STRING);
    key2 = jj_consume_token(STRING);
System.out.println("Parsed Plugin: PluginId=" + pluginId.image + " Key1=" + key1.image + " Key2=" + key2.image);
}

  final public void ScriptContent() throws ParseException {Token content;
    jj_consume_token(SCRIPT);
    content = jj_consume_token(STRING);
